import grass1 from "../assets/projects/touchsomegrass/g1.png";
import grass2 from "../assets/projects/touchsomegrass/g2.png";
import grass3 from "../assets/projects/touchsomegrass/g3.png";
import Nograss1 from "../assets/projects/touchsomegrass/ng1.png";
import Nograss2 from "../assets/projects/touchsomegrass/ng2.png";
import Nograss3 from "../assets/projects/touchsomegrass/ng3.png";
import Nograss4 from "../assets/projects/touchsomegrass/ng4.png";
import Nograss5 from "../assets/projects/touchsomegrass/ng5.png";
...
export const HERO_CONTENT = `Hi, I’m Araju Sharma, a recent Computer Science graduate from the University of Colorado Boulder with a minor in Creative Tech and Design. I have 3 years of hands-on experience in full-stack development, specializing in front-end frameworks like React, Next.js, and TailwindCSS, and back-end technologies including Node.js, PostgreSQL, and MongoDB. I’m passionate about building scalable, high-performance applications and have experience with Prisma, Firebase, Socket.io, and dynamic UI tools like Framer Motion.`;

export const ABOUT_TEXT = `My passion for web development began in Nepal and grew during my studies at CU Boulder. I enjoy collaborating on challenging projects and delivering quality solutions. Outside of coding, I stay active with hiking, snowboarding, or kayaking. I also enjoy contributing to open source to expand my skills on my free time. Some of my other cozy hobbies include painting, puzzles, or watching anime.`;
